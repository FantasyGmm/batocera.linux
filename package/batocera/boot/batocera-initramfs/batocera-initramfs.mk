...
define BATOCERA_INITRAMFS_QCS8550_EARLY_FIRMWARE
    mkdir -p $(INITRAMFS_DIR)/lib/firmware/qcom/sm8550/
    cp -R $(FIRMWARE_ARMBIAN_TARGET_DIR)/qcom/sm8550/* \
        $(INITRAMFS_DIR)/lib/firmware/qcom/sm8550/
endef
BATOCERA_INITRAMFS_PRE_INSTALL_TARGET_HOOKS += BATOCERA_INITRAMFS_QCS8550_EARLY_FIRMWARE
endif
