...
BATOCERA_INITRAMFS_DEPENDENCIES = lz4 host-lz4 firmware-armbian
...
define BATOCERA_INITRAMFS_ODIN2_EARLY_FIRMWARE
	mkdir -p $(INITRAMFS_DIR)/lib/firmware/qcom
	cp $(TARGET_DIR)/lib/firmware/qcom/a740_sqe.fw $(INITRAMFS_DIR)/lib/firmware/qcom
	cp $(TARGET_DIR)/lib/firmware/qcom/gmu_gen70200.bin $(INITRAMFS_DIR)/lib/firmware/qcom
	cp -R $(TARGET_DIR)/lib/firmware/qcom/sm8550/ $(INITRAMFS_DIR)/lib/firmware/qcom
	cp -R $(TARGET_DIR)/lib/firmware/qca/ $(INITRAMFS_DIR)/lib/firmware
	cp -R $(TARGET_DIR)/lib/firmware/ath12k/ $(INITRAMFS_DIR)/lib/firmware
endef
BATOCERA_INITRAMFS_PRE_INSTALL_TARGET_HOOKS += BATOCERA_INITRAMFS_ODIN2_EARLY_FIRMWARE
endif
