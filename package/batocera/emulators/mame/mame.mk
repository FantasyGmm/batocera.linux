...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_QCS8550),y)
# Temp hack for qcs8550 architectures : disable WERROR to avoid switchres log warning treated as error
...
# qcs8550 have OpenGL
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_QCS8550),y)
...
ifneq ($(BR2_PACKAGE_BATOCERA_TARGET_QCS8550),y)
